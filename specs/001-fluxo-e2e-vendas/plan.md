...
- `Program.cs` deve permanecer fino (orquestracao). Arquivos de entrada com mais de 350 linhas exigem
   tarefa explicita de decomposicao antes de adicionar novo comportamento.
- Mapeamento de endpoints e registro de DI devem ser separados por contexto (Auth, Catalogo, Pedidos,
   Admin, Health) em arquivos dedicados/extensoes.
